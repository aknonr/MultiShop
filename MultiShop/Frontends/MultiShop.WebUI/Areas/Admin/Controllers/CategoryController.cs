...
namespace MultiShop.WebUI.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        //Yeni bir kategori oluşturma metodu 
        [HttpPost]
        [Route("CreateCategory")]
        ...
        public async Task<IActionResult> CreateCategory(CreateCategoryDto createCategoryDto)
        {
            ...
            var jsondData=JsonConvert.SerializeObject(createCategoryDto); //createCategorydto aldığımız veriyi json formata dönüştürdük
        ...
        public async Task<IActionResult> DeleteCategory(string id)
        {
            ...
            if(responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index", "Category", new { arae = "Admin" });
            }
            return View();
        }
